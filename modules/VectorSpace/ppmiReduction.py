...
def ppmiReduction(inputPath, folds):
    ...
    print 'Initial Column Count: ', len(dataframe.columns)
    ...
    for current in range(1,folds+1):
        ...
        CopyDataFrame.to_csv('/home/skjena/data/reducedData/fold_'+str(current)+'.csv', sep=',', header=False,float_format='%.2f', index=False)
...
ppmiReduction('/home/skjena/data/PPMI', 4)
