...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, default='/home/service/cnnCancerTherapy/modules/HTTPRequest/projector/mnist-tensorboard-embeddings/mnist_data',
                        help='Directory for storing input data')
    parser.add_argument('--log_dir', type=str, default='/home/service/cnnCancerTherapy/modules/HTTPRequest/projector/mnist-tensorboard-embeddings/logs',
