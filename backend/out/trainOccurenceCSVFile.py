...
with tf.Session() as sess:
  ...
  l1 = tf.add(tf.matmul(example, label, hidden_1_layer['weights']) + hidden_1_layer['biases'])
  l1 = tf.nn.relu(l1)
  

  l2 = tf.add(tf.matmul(example, label, hidden_2_layer['weights']) + hidden_2_layer['biases'])
  l2 = tf.nn.relu(l2)

  l3 = tf.add(tf.matmul(example, label, hidden_3_layer['weights']) + hidden_3_layer['biases'])
  l3 = tf.nn.relu(l3)
